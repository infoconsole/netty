 ...
 * ${DESCRIPTION}
 */
public class TimeClient4Nio {
    private Selector selector;
    private final static int port = 8080;
    private final static int buff_size = 1024;

    public static void main(String[] args) throws IOException {
        TimeClient4Nio client = new TimeClient4Nio();
        client.init("localhost", port);
        client.connect();
    }

    public TimeClient4Nio() throws IOException {
        ...
        while (true) {
            ...
            while (ite.hasNext()) {
                ...
                if (selectionKey.isConnectable()) {
                    ...
                    socketChannel.write(ByteBuffer.wrap(new String("query time order").getBytes()));
